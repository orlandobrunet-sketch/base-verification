# NefroQuest — Guia Operacional para Codex
...
Este `AGENTS.md` **não substitui** esses documentos nem tem precedência sobre eles — apenas aponta para onde a regra editorial completa vive. Em caso de conflito, prevalece sempre o documento canônico.
...
| Função | Propósito |
|--------|-----------|
| `ai-mentor` | Oráculo dos Néfrons — Codex Haiku, 5 consultas/dia free |
| `ai-diagnosis` | Diagnóstico de lacunas — Codex Haiku, 3 consultas/dia free |
...
b. revisão formal pela skill `revisar-nefroquest` (`.Codex/skills/revisar-nefroquest/`);
...
**Criação** — use `.Codex/skills/criar-nefroquest/`:
...
**Revisão** — use `.Codex/skills/revisar-nefroquest/`:
