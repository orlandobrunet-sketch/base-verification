# NefroQuest — Roadmap legado (arquivado em 21/08/2026)

> Registro histórico preservado sem reconciliação de status. Não usar como fila de execução nem como direção visual atual. O roadmap ativo está em [`../ROADMAP.md`](../ROADMAP.md) e o sistema visual canônico em [`../design/NQ_LUMEN_VISUAL_SYSTEM_V1.md`](../design/NQ_LUMEN_VISUAL_SYSTEM_V1.md).
...
|---|----------|-----------|-----------------|
| E1 | **Motor adaptativo de aprendizado (IRT leve)** | **Concluído (v12.35)** — Ajusta a dificuldade por eixo temático em tempo real com base no histórico individual do usuário e lookahead swap na fila. | Retenção, engajamento premium |
...
| PED-2 | **Mapa de Competências** (área separada do radar por eixo) | **Concluído (v12.01)** — Camada de *tags de competência* sobre as questões e área própria na dashboard de competências mapeando o que o usuário domina ou tem em progresso. | Plano de desenvolvimento real; valor premium |
| PED-3 | **Onboarding com diagnóstico inicial (placement)** | **Concluído (v12.06)** — "Ritual de Iniciação" (`js/minigame.js`, `openRitual`, 8 questões adaptativas) estima o nível, pré-seleciona a dificuldade recomendada e semeia diretamente o agendamento FSRS a partir dos resultados. | Retenção desde o 1º minuto |
