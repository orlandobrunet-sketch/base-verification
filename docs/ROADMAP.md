...
4. **Simulado:** início, prova, retomada e resultado como fluxo próprio. *15.22:* virou página (spec 70). Corrigidos: teclado da prova respondia a questão escondida da jornada; `confirm()` nativo; prova com tempo esgotado fora do app sumia sem resultado; correção só por cor; falha ao baixar o banco de questões ficava guardada e impedia nova tentativa.
