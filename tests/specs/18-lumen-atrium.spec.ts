...
test.describe('Página 2 — Átrio da Jornada Lúmen', () => {
  ...
  test('carrega a página real e preserva os contratos funcionais', async ({ page }) => {
    ...
    expect(stylesheets).toContain('/styles/lumen/atrium.css?v=13.42');
    await expect(page.locator('script[src="js/atrium.js?v=13.23"]')).toHaveCount(1);
    await expect(page.locator('script[src="js/auth.js?v=13.42"]')).toHaveCount(1);
    await expect(page.locator('script[src="js/game.js?v=13.42"]')).toHaveCount(1);
