          ...
          <div class="modal-scroll-body" style="text-align:left;">
            ...
            <div style="background:linear-gradient(135deg,rgba(52,211,153,0.14),rgba(255,215,0,0.05));border:2px solid rgba(52,211,153,0.5);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(16,185,129,0.9);color:#fff;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.85</span>
                <span style="color:#a7f3d0;font-weight:bold;font-size:0.95rem;">Correção — Início de jornada</span>
              </div>
              <ul style="margin:0;padding-left:18px;color:#c8d8f0;font-size:0.82rem;line-height:1.8;">
                <li><strong>🐛 Tela travada ao iniciar nova jornada</strong> — Em alguns casos (contas antigas / sincronização), a classe escolhida era perdida no momento de começar e o jogo travava na tela de introdução do personagem. Agora a jornada sempre inicia, preservando a classe escolhida.</li>
              </ul>
            </div>

            <!-- v11.83 -->
            <div style="background:linear-gradient(135deg,rgba(168,85,247,0.18),rgba(255,215,0,0.06));border:2px solid rgba(168,85,247,0.55);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(168,85,247,0.9);color:#fff;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.83</span>
                <span style="color:#e9d5ff;font-weight:bold;font-size:0.95rem;">Ritual de Iniciação</span>
              </div>
              <ul style="margin:0;padding-left:18px;color:#c8d8f0;font-size:0.82rem;line-height:1.8;">
                <li><strong>⚜️ Alinhe sua dificuldade</strong> — Novo botão na tela inicial: um teste adaptativo de 8 questões que recomenda a dificuldade da sua jornada conforme sua base atual. As questões se adaptam às suas respostas; o resultado já pré-seleciona o modo. É só diagnóstico (não conta para jornada/ranking) e pode ser refeito quando quiser.</li>
              </ul>
            </div>
            ...
            <div style="background:linear-gradient(135deg,rgba(255,215,0,0.16),rgba(255,215,0,0.05));border:2px solid rgba(255,215,0,0.5);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(255,215,0,0.9);color:#1a0e00;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.76</span>
                <span style="color:#fef3c7;font-weight:bold;font-size:0.95rem;">Biblioteca de Néfrons</span>
              </div>
              <ul style="margin:0;padding-left:18px;color:#c8d8f0;font-size:0.82rem;line-height:1.8;">
                <li><strong>📚 Nova aba no Dashboard</strong> — Os artigos históricos da nefrologia que você desbloqueia nos baús agora ficam reunidos numa galeria de cards, com raridade, resumo, conclusão, impacto e curiosidades. Clique no card para expandir.</li>
                <li><strong>Progresso da coleção</strong> — Barra mostrando quantos artigos você já revelou do total.</li>
              </ul>
            </div>
            ...
            <div style="background:linear-gradient(135deg,rgba(56,189,248,0.18),rgba(56,189,248,0.06));border:2px solid rgba(56,189,248,0.6);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(56,189,248,0.9);color:#04222e;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.75</span>
                <span style="color:#e0f2fe;font-weight:bold;font-size:0.95rem;">Ajustes do Dashboard</span>
              </div>
              <ul style="margin:0;padding-left:18px;color:#c8d8f0;font-size:0.82rem;line-height:1.8;">
                <li><strong>Ranking com abas 📊</strong> — A aba Ranking do Dashboard agora diferencia <strong>Recorde</strong> (por partida) e <strong>Perfil Global</strong> (acertos acumulados).</li>
                <li><strong>Avatar do Dr. Glomerulus 🖼️</strong> — Corrigida a imagem do personagem na Jornada Ativa (usava extensão errada).</li>
              </ul>
            </div>
            ...
            <div style="background:linear-gradient(135deg,rgba(255,215,0,0.16),rgba(255,215,0,0.05));border:2px solid rgba(255,215,0,0.6);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(255,215,0,0.9);color:#1a0e00;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.72</span>
                <span style="color:#fef3c7;font-weight:bold;font-size:0.95rem;">Ranking de Perfil Global</span>
              </div>
              <ul style="margin:0;padding-left:18px;color:#c8d8f0;font-size:0.82rem;line-height:1.8;">
                <li><strong>Perfil Global 📊</strong> — O Ranking Global agora tem duas abas: <strong>Recorde</strong> (melhor pontuação de uma partida, como antes) e <strong>Perfil Global</strong>, que classifica pelos <strong>acertos acumulados</strong> ao longo de toda a jornada — premiando consistência, não só um jogo perfeito.</li>
              </ul>
            </div>
            ...
            <div style="background:linear-gradient(135deg,rgba(56,189,248,0.18),rgba(56,189,248,0.06));border:2px solid rgba(56,189,248,0.6);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(56,189,248,0.9);color:#04222e;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.69</span>
            ...
            <div style="background:linear-gradient(135deg,rgba(168,85,247,0.18),rgba(168,85,247,0.06));border:2px solid rgba(168,85,247,0.6);border-radius:10px;padding:16px;margin-bottom:12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                <span style="background:rgba(168,85,247,0.9);color:#fff;font-size:0.75rem;font-weight:900;padding:3px 10px;border-radius:20px;font-family:'Cinzel',serif;">v11.67</span>
                <span style="color:#e9d5ff;font-weight:bold;font-size:0.95rem;">Títulos de Herói por Nível</span>
              </div>
              <ul style="margin:0;padding-left:18px;color:#c8d8f0;font-size:0.82rem;line-height:1.8;">
                <li><strong>Subtítulo único a cada nível 🎖️</strong> — O subtítulo do herói agora muda em todos os níveis (antes repetia entre faixas), com nomes temáticos próprios para cada classe.</li>
              </ul>
            </div>
